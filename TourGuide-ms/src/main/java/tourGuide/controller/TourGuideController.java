...
public class TourGuideController {
    ...
    // New endpoint requested by the client: a way to list all users (id + name),
// which didn't exist before - TourGuideService.getAllUsers() was only
// reachable from Java code, never exposed over HTTP.
    @RequestMapping("/getAllUsers")
    public String getAllUsers() {
        return JsonStream.serialize(tourGuideService.getAllUserSummaries());
    }
}