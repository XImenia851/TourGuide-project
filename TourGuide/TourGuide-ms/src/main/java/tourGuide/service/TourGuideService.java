...
public class TourGuideService {
	...
	// Lightweight summary of a user - just enough to identify them (id + name),
// instead of serializing the full User object with its visited locations,
// rewards, preferences and trip deals, which would be huge and mostly
// irrelevant for a simple "list all users" view.
	public static class UserSummary {
		public String userId;
		public String userName;

		public UserSummary(String userId, String userName) {
			this.userId = userId;
	...
	public List<UserSummary> getAllUserSummaries() {
		return getAllUsers().stream()
				.map(user -> new UserSummary(user.getUserId().toString(), user.getUserName()))
				.collect(Collectors.toList());
	}
